...
# надо сделать
1. кнопка информации о файле должна быть не сверху таблицы а внутри неё напротив каждого из файлов. под таблицей строка с примерным размером и времением сжатия не нужна её надо удалить так как в таблице у нас итак у каждого файла есть в столбцах эта информация.
4. всё что щас в окне программы это должна быть первая основная вкладка. логи выносим в отдельную вкладку вторую и назовем её логи. причем щас часть логов идут в консоль а не в наше окно гуи. надо чтобы все абсолютно логи шли в наше окно гуи во вкладку логи туда.
