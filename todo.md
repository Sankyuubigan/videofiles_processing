...
# надо сделать
1. паузу нажимать на всю очередь.
4. 
5. 
...
время текущее давай писать в логах когда сжатие файла завершено. также в логах давай писать сколько сжатие по длительности происходило.
